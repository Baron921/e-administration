(function (c) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (f) { return c(f, window, document) }) : "object" === typeof exports ? module.exports = function (f, b) { f || (f = window); if (!b || !b.fn.dataTable) b = require("datatables.net")(f, b).$; b.fn.dataTable.Buttons || require("datatables.net-buttons")(f, b); return c(b, f, f.document) } : c(jQuery, window, document) })(function (c, f, b, n) {
    var i = c.fn.dataTable, e = b.createElement("a"), m = function (a) {
        ...
        className: "buttons-print", text: function (a) { return a.i18n("buttons.print", "<i class=\"fa fa-print pr-1\"> </i> Imprimer") }, action: function (a, b, e, h) {
            ...
            try { g.document.head.innerHTML = j } catch (p) { c(g.document.head).html(j) } g.document.body.innerHTML = "<h1 class='text-center'>" + "Liste des opérations réalisées" + "</h1><div>" + (e.messageTop || "") + "</div>" + d + "<div>" + (e.messageBottom || "") + "</div>"; c(g.document.body).addClass("dt-print-view"); c("img", g.document.body).each(function (b, a) { a.setAttribute("src", m(a.getAttribute("src"))) }); h.customize && h.customize(g, h, b); g.setTimeout(function () { h.autoPrint && (g.print(), g.close()) }, 1E3)
        }, title: "*", messageTop: "*", messageBottom: " <div class='filigrame'> <p class='' style='color:lightgrey; opacity: 0.2; font-size:100px; margin: 40% 0 0 13%; transform:rotate(300deg); -webkit-transform:rotate(300deg); '> Acte administratif </p> </div> ", exportOptions: {}, header: !0, footer: !1,
