...
<div class="" id="presentOperation">
    ...
    <div class="row menuOperation">
        <div class="col-md-4">
            <div class="mb-4 operationBloc input-group shadow-lg bg-white rounded">
                <div class="col-md-12">
                    <div class="mytitle">
                        <h6 class="">
                            Choisir une administration
                        </h6>
                    </div>
                    <nav class="" id="menu">
                        <ul>
                            ...
                            @foreach($user as $users)
                                <li class="choix_operation">
                                    <a class="butonOperation" data-id="{{$users}}" id="choice{{$users->id}}"
                                       data-url="{{route('acte.institution', [$users->id, $users->nom])}}"
                                       href="{{route('acte.institution', [$users->id, $users->nom])}}">
                                        {{$users->nom}}
                                    </a>
                                </li>
                                <hr>
