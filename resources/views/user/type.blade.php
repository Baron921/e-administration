        ...
        <div class="col-md-8 col-xs-8 offset-md-2 pt-2">
            <div class="menu-toggle">
                <h6 class="hover-bar" data-target="#buton-show"
                    data-toggle="collapse"> Opération par type
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.butonOperation', function () {
        ...
        $(document).on('click', '.butontype', function (e) {

            //e.preventDefault();

            //alert("FLORIAS BONJOUR");

            //history.pushState({}, "", "");

            let type_button = $('#menu');

            //type_button.html(" ");

            //let tableMenu = " fdsfbjk ";


            //type_button.append(tableMenu);
